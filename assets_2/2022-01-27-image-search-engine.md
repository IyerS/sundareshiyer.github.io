...
<br>
![alt text]({{ site.baseurl }}/assets/img/project-images/search-engine-image-examples.png "Deep Learning Search Engine - Image Examples")
...
<br>
![alt text]({{ site.baseurl }}/assets/img/project-images/search-engine-search1.jpg "VGG16 Architecture")
...
**Search Image**
<br>
![alt text]({{ site.baseurl }}/assets/img/project-images/search-engine-search1.jpg "Search 1: Search Image")
<br>
<br>
**Search Results**
![alt text]({{ site.baseurl }}/assets/img/project-images/search-engine-search1-results.png "Search 1: Search Results")
...
**Search Image**
<br>
![alt text]({{ site.baseurl }}/assets/img/project-images/search-engine-search2.jpg "Search 2: Search Image")
<br>
<br>
**Search Results**
![alt text]({{ site.baseurl }}/assets/img/project-images/search-engine-search2-results.png "Search 2: Search Results")
